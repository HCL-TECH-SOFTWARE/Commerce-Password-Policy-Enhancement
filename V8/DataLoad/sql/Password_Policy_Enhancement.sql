...
-- Insert Custom Configuration for existing Password Policy from PLCYPASSWD to X_PLCYPASSWD 
-- Sample Insert Statement: use <PLCYPASSWD_ID> from PLCYPASSWD table
INSERT INTO X_PLCYPASSWD(PLCYPASSWD_ID, MINUCASEPASSWDLEN, MINLCASEPASSWDLEN, MINNONALPHABETIC, CHARORDER, STORESITE) VALUES (<PLCYPASSWD_ID>, 2, 3, 2, 1,  '1-aurora.com|11-emerald');
